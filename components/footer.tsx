      ...
      <div className="section-container grid gap-10 md:grid-cols-3">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-cream/90">
            ...
            <li><a href={company.telegram} target="_blank" rel="noreferrer" className="hover:text-gold">{company.telegramHandle}</a></li>
            <li><a href={company.instagram} target="_blank" rel="noreferrer" className="hover:text-gold">Instagram</a></li>
            <li><a href={company.linkedin} target="_blank" rel="noreferrer" className="hover:text-gold">LinkedIn</a></li>
            <li><a href={company.facebook} target="_blank" rel="noreferrer" className="hover:text-gold">Facebook</a></li>
          </ul>
        </div>
      </div>
