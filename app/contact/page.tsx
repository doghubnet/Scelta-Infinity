...
export default function ContactPage() {
  return (
    <section className="section-container">
      <SectionTitle eyebrow="Contact Us" title="Let’s Connect Professionally" description="Reach Scelta Infinity for publishing, affiliate collaboration, and service inquiries." />
      <div className="grid gap-8 md:grid-cols-2">
        <div className="space-y-3 rounded-3xl border border-navy/10 bg-white p-8 shadow-luxury">
          ...
          <p><strong>Fiverr:</strong> <a className="text-gold underline" href={company.fiverr}>{company.fiverr}</a></p>
          <p><strong>Upwork:</strong> <a className="text-gold underline" href={company.upwork}>{company.upwork}</a></p>
